...
//Negative tests
  ...
  it('First page should have only "Next page" button', () => {
      cy.visit('https://relay.prototyp.digital/');
      cy.get('.css-scukn3').contains('Previous page').should('not.exist');
      cy.get('.css-scukn3').contains('Next page').should('exist');
  })

  it('Last page should have only "Previous page" button', () => {
    ...
    cy.get('.css-scukn3').contains('Previous page').should('exist');
})
