...
//Negative test
     ...
     it ('Check that "Design" page displays a messagge "There are currently no articles in this category"', () => {
        cy.visit('https://relay.prototyp.digital/category/design');
        cy.contains('There are currently no articles in this category').should('be.visible');
